...
generations --- inside the published probe range --- and
a closely matched reconstruction of the closest published early-window
positive recovers a comparable pooled result at $t{=}4$ (0.849)
while within problem it is statistically indistinguishable from chance at
all ten anchors (0.496 at $t{=}4$); a post-hoc within-targeted check
finds only a small, late residual concentrated in three problems.
\end{itemize}
