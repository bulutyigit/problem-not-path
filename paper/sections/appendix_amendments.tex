...
The cohorts were collected in staged \emph{waves}; the expansion cohort
is wave~3, and released artifact files keep the wave-numbered names.
...
Section~\ref{sec:results-prediction}. A within-problem robustness check
run after reporting is labeled post-hoc in the same document and in
Appendix~\ref{app:within-robust}.
