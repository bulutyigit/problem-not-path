...
straddling zero (Figure~\ref{fig:sweep}): the absence of detected gain is
not an artifact of the chosen window. These are absences of detected gain,
...
at every one of ten anchors from $t = 4$ to $512$
(Figure~\ref{fig:dissect}); the upper confidence limits bound any
within-attempt AUROC signal at $t = 4$ by $0.527$ (failure-weighted) and
$0.562$ (pair-weighted). The pooled positive is therefore predominantly
