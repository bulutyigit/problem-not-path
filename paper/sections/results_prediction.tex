...
reported by \citet{david2025temporal}. The pooled replication and the
within-problem analysis use different evaluation sets: the former
preserves the published 8-per-problem design, the latter uses all 256
...
trajectories: the pooled positive replicates at $t=4$ and is
