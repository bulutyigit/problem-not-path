...
problems ($n{=}5{,}632$; 2{,}178 failures), under the pre-registered
...
pooled AUROC 0.981 (255 other attempts per problem); stream-summary probe
...
\textbf{Classifiers.} All probes and the confirmatory models are
$\ell_2$ logistic regression (C $= 0.1$, liblinear, class-weight
balanced, max 5{,}000 iterations) on standardized features; raw-state
probes add PCA to at most 128 components. Folds are
StratifiedGroupKFold with problems as groups. Confidence intervals are
percentile bootstraps over 2{,}000 problem-clustered draws.
