...
the larger budget --- while Gemma-3n's early crossings remain pinned,
...
of Ministral-3's 16 threshold-censored candidates and rejected Gemma-3n's
...
one added; Gemma-3n's changes were mostly interval shifts).
...
primary endpoint the baseline scores 1.00 for Gemma-3n ($n{=}16$) and 0.69
