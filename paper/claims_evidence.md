...
| C11 | An early-window probe positive replicates and is dissected: all problem-identity, zero within-attempt signal, and the state's difficulty content decays by t≈16 | artifacts/external/math128_distill7b/analysis/math128_probe_report.json (frozen amendment 2026-08-31) | t=4 pooled 0.849 [0.735,0.919] vs within-problem 0.496 [0.466,0.527]; within at chance at all 10 anchors; LOO ceiling 0.974; fidelity 0.906; 6,480 public R1-Distill-7B trajectories, no generation | math128_probe_dissection.png |
