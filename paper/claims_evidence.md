...
| C4 | Accumulated reasoning = compute compression, not reachability | terminal_stability_wave3 + labels (13 censored cells) | in-grid matched comparisons: prefix wins 9/9 (median +0.31); 4 boundary proxies (R(9216) unmeasured, bias direction unknown): 2 wins 2 ties; restart@8192 reaches τ 11/13, matches prefix rate 9/13 | wave3_matched_compute.png |
