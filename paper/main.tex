...
cells survives as prefix-limited under the frozen rules (three cells cross
the advantage margin; an in-grid restart already solves two); (ii) restart dose--response
...
beats restarting in 11/13 late-crossing cells, yet an 8{,}192-token restart
reaches the same threshold in 11/13 and the prefix's own success rate in
9/13 --- accumulated reasoning acts as \emph{compute
