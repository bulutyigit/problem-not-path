...
statistically indistinguishable from chance within problem (0.496) at
every anchor. Pooled probe AUROCs should be read as difficulty
measurements until a question-only baseline or within-problem evaluation
shows otherwise.
\end{abstract}
